/**
 * Page: About
 * Purpose: Static informational page describing the app and the creator.
 * Loads profile image data from `static-files.json` and renders a brief bio.
 */
  ...
  return (
    <section id="About">
      <div className="wrapper md:ml-10 xl:ml-20">
        ...
        <div className="container-about flex-col! xl:flex-row! md:flex-row!">
          ...
          <div className="about-card xl:w-[30%]">
            ...
            <div className="about-bio">
              ...
              <p className="text-sm font-light">
                ...
                help fellow readers to discover books with ease with the help of
                AI.
              </p>
            </div>
          </div>
